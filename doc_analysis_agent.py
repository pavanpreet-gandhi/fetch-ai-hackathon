...
messages = [
    {"role": "system", 'content': "You are an expert in finance and insurance. Your job is to output a set of rules that map users to schemes. This is the document containing the finformation for the schemes {mode}"}
]
